...
class ScanNet(data.Dataset):
	...
	def __init__(self, root_dir, mode='train', transform=None, label_transform = None, \
		...
		if self.mode.lower() == 'train':
			...
			color_images, depth_images, labels = utils.get_filenames_scannet(self.root_dir+'/train/')
			...
			color_images, depth_images, labels = utils.get_filenames_scannet(self.root_dir+'/val/')
			...
			color_images, depth_images, labels = utils.get_filenames_scannet(self.root_dir+'/test/')
